app.controller('operatorController', ['$scope', '$state', '$rootScope', '$uibModal', 'partyService', 'messageService', 'gridMap',
  function ($scope, $state, $rootScope, $uibModal, partyService, messageService, gridMap) {
    ...
    var success = function (res) {
      ...
      init = function () {
        partyService.getParty('operator').then(success, function () {
          $state.go('login');
        });
      },
