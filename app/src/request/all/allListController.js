app.controller('allListController', ['$scope', '$state', '$rootScope', '$q', '$filter', 'config', 'requestService', 'vehicleService', 'driverService', 'partyService', 'messageService', 'pdfService',
