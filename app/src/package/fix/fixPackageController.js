app.controller('fixPackageController', ['$scope', '$state', '$rootScope', '$uibModal', 'packageService', 'messageService', 'gridMap',
  function ($scope, $state, $rootScope, $uibModal, packageService, messageService, gridMap) {
    ...
    var success = function (res) {
      ...
      init = function () {
        packageService.getPackage('fix').then(success, function () {
          $state.go('login');
        });
      },
